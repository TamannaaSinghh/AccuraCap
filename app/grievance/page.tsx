...
export default function GrievancePage() {
  return (
    <main className="relative w-full px-6 py-20">
      ...
      <div className="max-w-[1100px] mx-auto space-y-10 text-gray-700 leading-relaxed pt-10">
        ...
        <section className="space-y-4">
          ...
          {/* Contact Box */}
          <div className="bg-white/70 backdrop-blur-md border border-gray-200 rounded-xl p-5 shadow-sm space-y-2">
            ...
            <p>
              ...
              <span className="text-red-600">compliance@accuracap.com</span>
            </p>
          </div>

          <p>
            Clients can also email their complaints to a dedicated email ID i.e{" "}
            <span className="text-red-600">grievances@accuracap.com</span>
          </p>
          ...
          <p>
            <span className="font-medium text-gray-900">Email:</span>{" "}
            <span className="text-red-600">director@accuracap.com</span>
          </p>
          ...
          <p>
            ...
            and investors can file complaints by clicking “Complaint Registration” and “Investor Corner”.
